...
<?php
    ...
    <main class="container">
        <?php         
         $rec = $db->query("SELECT * FROM produit where id= $produitId")->fetchAll(PDO::FETCH_OBJ);
         echo('
                        ...
                        <div class="mt-4">
                            <div class="btn ">
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" name>Add to Card</button>
                                </div>
                            </div>                        
                        </div>
